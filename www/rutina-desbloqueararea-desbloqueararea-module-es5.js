...
var DesbloquearareaPageRoutingModule = /** @class */ (function () {
    function DesbloquearareaPageRoutingModule() {
    }
    ...
    return DesbloquearareaPageRoutingModule;
}());
...
var DesbloquearareaPageModule = /** @class */ (function () {
    function DesbloquearareaPageModule() {
    }
    ...
    return DesbloquearareaPageModule;
}());
...
var DesbloquearareaPage = /** @class */ (function () {
    function DesbloquearareaPage(consultaService) {
        this.consultaService = consultaService;
        this.oficinas = null;
        this.respuesta = null;
    }
    DesbloquearareaPage.prototype.ngOnInit = function () {
        var _this = this;
        console.log('AQUI');
        this.consultaService.getOficinas().subscribe(function (res) {
            console.log(res);
            _this.oficinas = res;
        });
        console.log('oficinas: ', this.oficinas);
    };
    DesbloquearareaPage.prototype.bloquarArea = function (oficina) {
        var _this = this;
        console.log(oficina);
        this.consultaService.desbloqueaArea(oficina.id).subscribe(function (res) {
            console.log(res);
            _this.respuesta = res;
        });
        console.log('respuesta: ', this.respuesta);
    };
    DesbloquearareaPage.prototype.desbloquarArea = function (oficina) {
        console.log(oficina);
    };
    DesbloquearareaPage.ctorParameters = function () { return [
...
var ConsultaService = /** @class */ (function () {
    ...
    ConsultaService.prototype.getOficinas = function () {
        return this.httpClient.get('http://10.8.6.28:8080/getOficinas');
    };
    ConsultaService.prototype.desbloqueaArea = function (area) {
    ...
    ConsultaService.ctorParameters = function () { return [
...
//# sourceMappingURL=rutina-desbloqueararea-desbloqueararea-module-es5.js.map